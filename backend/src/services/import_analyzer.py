...
DEGRADATION_IMPACTS: dict[str, DegradationImpact] = {
    ...
    "subject": DegradationImpact(field="subject", impact="无法按学科筛选", fallback="将根据课程名称自动推断学科"),
    "category": DegradationImpact(field="category", impact="无法按课程属性筛选", fallback="将根据课程名称自动推断课程属性"),
...
SYSTEM_FIELDS_DESC = {
    ...
    "campus": "校区（如：校区、院区）",
    "subject": "学科/学科分类/专业（如：学科、学科分类、专业分类、院系）",
    "category": "课程属性/类型/分类（如：课程属性、课程类型、课程性质）",
